        ...
        implements Serializable
{
     ...
     */
    private static final MapType mType = MapType.HASH_MAP; //change this every time
    public final MapType mTypePublic = mType; //change this every time
    /** Choose one item to display Select or Join Graph,
     * Select "None' to generate evaluation data
     */
    public final String chartDisplay = "None"; //values = Select, Join, None
